...
$title = 'PriestCalendar';
$currentPage = 'priestcalendar'; 
?>
<!DOCTYPE html>
<html lang="en-US">
...
<div class="container">
   <h3 class="pageheading text-center">PRIEST CALENDAR</h3>
   <br>
   <div id="calendar"></div>
</div>
        ...
        <div class="modal-dialog">  
            <div class="modal-content">  
                  <div class="modal-header">  
                      ...
                      <h4 class="modal-title">Priest Service Request Details</h4>  
                  </div>  
...
<script type="text/javascript">
  function ajaxAction(action) {
        $.ajax({
                  type: "POST",  
                  url: "PriestAction.php",  
                  data: {edit_id:document.getElementById("edit_id").
                      value,act:action},
                  success: function() {
